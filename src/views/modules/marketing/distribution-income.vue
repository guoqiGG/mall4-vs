      ...
      <el-form @submit.native.prevent :inline="true" class="search-form" ref="searchForm" :model="searchForm" size="small">
        <div class="input-row">
          <el-form-item :label="$t('distribUserWallet.mobileTelNumber') + ':'">
            <el-input style="min-width: 260px;" type="text" v-model="searchForm.userMobile" :placeholder="$t('distribUserWallet.mobileTelNumber')"></el-input>
          </el-form-item>
    ...
    <div class="main-container">
      ...
      <div class="table-con distribution-income-table">
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div class="tag-text" v-if="!scope.row.incomeType">-</div>
          ...
          >
            <template slot-scope="scope">
              <div class="tag-text" v-if="!scope.row.state">-</div>
