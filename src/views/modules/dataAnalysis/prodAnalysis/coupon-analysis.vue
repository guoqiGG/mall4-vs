  ...
  <div class="mod-coupon">
    ...
    <div class="one">
      ...
      <div class="title-line">
        ...
        <div class="title-left">
          ...
          <span class="title-txt">{{$t("dataAnaly.keyInVolumeYes")}}</span>
        </div>
      </div>
        ...
        <el-row>
          <el-col :span="12">
            <div class="grid-content dotted">
              ...
              <div>{{$t("dataAnaly.numberOfRe")}}</div>
            </div>
          </el-col>
          <!-- <el-col :span="6">
            <div class="grid-content dotted">
          ...
          <el-col :span="12">
            <div class="grid-content dotted">
              ...
              <div>{{$t("dataAnaly.microMallUsage")}}</div>
            </div>
          </el-col>
          <!-- <el-col :span="6">
    ...
    <div class="one">
      ...
      <div class="title-line">
        ...
        <div class="title-left">
          <p class="blue-vertical"></p>
          <span class="title-txt">{{$t("dataAnaly.cardVolumeTrendChart")}}</span>
        </div>
      </div>
    ...
    <div class="one">
      ...
      <div class="title-line">
        ...
        <div class="title-left">
          <p class="blue-vertical"></p>
          <span class="title-txt">{{$t("dataAnaly.detailedData")}}</span>
        </div>
      </div>
      <div>
        <div>
          <el-form @submit.native.prevent :inline="true" class="demo-form-inline">
            <el-form-item>
              <span>{{$t("dataAnaly.pickupTime")}}</span>
              <el-date-picker
                size="small"
                v-model="dateRange"
                type="daterange"
        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="couponType" :label="this.$i18n.t('coupon.couponType')">
            <template slot-scope="{row}">
              <el-tag v-if="row.couponType === 1" type="success">{{$t("coupon.voucher")}}</el-tag>
              <el-tag v-if="row.couponType === 2" type="warning">{{$t("coupon.discountCoupon")}}</el-tag>
              <el-tag v-if="row.couponType === 3" type="danger">{{$t("coupon.excCerti")}}</el-tag>
            </template>
          </el-table-column>
          <el-table-column prop="takeNum" :label="this.$i18n.t('dataAnaly.numberOfRe')"></el-table-column>
          <!-- <el-table-column prop="verifyNum" label="验证次数"></el-table-column> -->
          <el-table-column prop="useNum" :label="this.$i18n.t('dataAnaly.microMallUsage')"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getCouponAnalysis () {
      ...
      this.$http({
        url: this.$http.adornUrl('/multishop/prodAnalysis/getCouponAnalysis'),
        method: 'get',
        ...
        if (data) {
          ...
          this.dateArr = []
          this.seriesDataArr = []
          let obj1 = this.initObj(this.$i18n.t('dataAnaly.numberOfRe'))
          let obj2 = this.initObj(this.$i18n.t('dataAnaly.microMallUsage'))
          data.forEach(i => {
    ...
    getCouponParam (page) {
      this.dataListLoading = true
      this.$http({
        url: this.$http.adornUrl('/multishop/prodAnalysis/getCouponAnalysisParamByDate'),
        method: 'get',
        params: this.$http.adornParams(
          {
    ...
    getCouponChart () {
      ...
      const option = {
        ...
        legend: {
          data: [this.$i18n.t('dataAnaly.numberOfRe'), this.$i18n.t('dataAnaly.microMallUsage')]
        },
        xAxis: {
          type: 'category',
          boundaryGap: false,
