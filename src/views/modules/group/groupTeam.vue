        ...
        <div class="table-con group-team">
          <el-table :data="dataList" header-cell-class-name="table-header" row-class-name="table-row-low" style="width: 100%">
            <!-- <el-table-column align="left" type="index" :label="$t('formData.serialNumber')" width="85"></el-table-column> -->
              <el-table-column prop="activityName" :label="$t('groups.eventName')" width="200">
            ...
            <el-table-column min-width="120" prop="startTime" :label="$t('group.groupTime')">
              <template slot-scope="scope">
                <div>
            ...
            <el-table-column min-width="100" prop="groupNumber" :label="$t('groups.numberOfParticipants')" sortable>
              <template slot-scope="scope">
                <div>
            ...
            <el-table-column min-width="120" prop="totalPrice" :label="$t('group.totalOrderAmount')" sortable>
              <template slot-scope="scope">
                <div>
            ...
            <el-table-column min-width="240" align="center" :label="$t('order.operation')">
              <template slot-scope="scope">
