      ...
      <el-form @submit.native.prevent :inline="true" class="search-form" ref="searchForm" :model="searchForm" label-width="auto" size="small">
        ...
        <div class="input-row">
          <el-form-item :label="$t('stock.createOrderTime')">
            ...
            ></el-date-picker
            >&nbsp;
            <div class="default-btn" style="margin-left: 20px;" :class="{ 'is-active': createTimeActive === 1 }" @click="setDateRange(1, 'createTime')">{{
              $t("time.t")
            }}</div>
            <div class="default-btn" :class="{ 'is-active': createTimeActive === 2 }" @click="setDateRange(2, 'createTime')">{{
              $t("time.y")
            }}</div>
            <div class="default-btn" :class="{ 'is-active': createTimeActive === 3 }" @click="setDateRange(3, 'createTime')">{{
              $t("time.n")
            }}</div>
            <div class="default-btn" :class="{ 'is-active': createTimeActive === 4 }" @click="setDateRange(4, 'createTime')">{{
              $t("temp.m")
            }}</div>
          </el-form-item>
        </div>
        <div class="input-row">
          <el-form-item :label="type === 1 ? $t('stock.outStockTime') : $t('stock.inStockTime')">
            ...
            ></el-date-picker
            >&nbsp;
            <div class="default-btn" style="margin-left: 20px;" :class="{ 'is-active': businessTimeActive === 1 }" @click="setDateRange(1, 'businessTime')">{{
              $t("time.t")
            }}</div>
            <div class="default-btn" :class="{ 'is-active': businessTimeActive === 2 }" @click="setDateRange(2, 'businessTime')">{{
              $t("time.y")
            }}</div>
            <div class="default-btn" :class="{ 'is-active': businessTimeActive === 3 }" @click="setDateRange(3, 'businessTime')">{{
              $t("time.n")
            }}</div>
            <div class="default-btn" :class="{ 'is-active': businessTimeActive === 4 }" @click="setDateRange(4, 'businessTime')">{{
              $t("temp.m")
            }}</div>
          </el-form-item>
        </div>
