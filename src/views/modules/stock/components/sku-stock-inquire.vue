      ...
      <el-form @submit.native.prevent :inline="true" class="search-form" ref="searchForm" :model="searchForm" label-width="auto" size="small">
        ...
        <div class="input-row">
          ...
          <el-form-item  :label="$t('product.stockWarning') + ':'">
            <el-select    v-model="searchForm.isStockWarning" :placeholder="$t('product.stockWarning')" clearable>
...
export default {
  ...
  props: ['isStockWarning'],
  created () {
    this.searchForm.isStockWarning = this.isStockWarning
    this.init()
  },
  methods: {
    init () {
