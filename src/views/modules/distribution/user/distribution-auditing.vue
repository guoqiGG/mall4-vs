...
export default {
  ...
  methods: {
    sortChange (column) {
      ...
      const sortParams = {}
      switch (column.prop) {
        case 'sumOfConsumption': sortParams.sortParam = 1
          break
        case 'expenseNumber': sortParams.sortParam = 2
          break
        case 'auditingTime': sortParams.sortParam = 3
          break
        default: sortParams.sortParam = 0
          break
      }
      // 排序类型 0无 1 正序 2倒序
      switch (column.order) {
        case 'descending': sortParams.sortType = 2
          break
        case 'ascending': sortParams.sortType = 1
          break
        default: sortParams.sortType = 0
          break
      }
