<template>
  <div class="trading">
    <div class="search-bar">
      <el-form @submit.native.prevent clearable :inline="true" :model="dataFrom" class="demo-form-inline from" size="small">
        <div class="input-row">
          ...
          <el-form-item :label="this.$i18n.t('shop.reason') + ':'">
            <el-select style="min-width: 230px;" v-model="dataFrom.reason" clearable :placeholder="this.$i18n.t('shop.reason')">
              <el-option
