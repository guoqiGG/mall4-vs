...
export default {
  ...
  data () {
    ...
    return {
      ...
      currentCard: {}, // 当前银行卡
      dialogWidth: '',
      defWidth: localStorage.getItem('bbcLang') === 'en' ? 800 : 700,
      labelWidth: localStorage.getItem('bbcLang') === 'en' ? '170px' : '120px',
      count: null,
      showCount: null,
      timer: null
    }
  ...
  methods: {
     ...
     */
    handleInput (value) {
      this.dataForm.shopRemarks = value.replace(/[^a-zA-Z0-9\u4E00-\u9FA5.]/g, '')
    },
    /**
     * 获取店铺钱包信息
     */
