<template>
  <div class="business-info-wrap">
    <div class="business-info-mod">
      <el-form @submit.native.prevent ref="companyInfoForm" label-width="140px" :model="companyInfoForm" size="small">
        <div class="ci-wrapper">
          ...
          <div class="left-item-wrap">
            ...
            <el-form-item :label="$t('shopProcess.businessTerm') + '：'" required>
              {{ companyInfoForm.startTime.slice(0,10) + ' - ' + (!companyInfoForm.endTime ? this.$i18n.t('shopProcess.noFixedTerm') : companyInfoForm.endTime.slice(0, 10)) }}
            </el-form-item>
