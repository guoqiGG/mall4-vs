<template>
  ...
  <div class="popup">
    ...
    <!-- 修改信息 -->
    <el-form @submit.native.prevent ref="modifyInformation" label-width="140px" :model="modifyInformation" size="small">
        <div class="ci-wrapper">
          <div class="left-item-wrap">
            ...
            <el-form-item :label="$t('shopProcess.businessTerm') + '：'" required>
              {{ modifyInformation.startTime.slice(0,10) + ' - ' + (!modifyInformation.endTime ? $t('shopProcess.noFixedTerm') : modifyInformation.endTime.slice(0, 10)) }}
            </el-form-item>
