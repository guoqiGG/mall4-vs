  ...
  <div class="app-container shop-detail">
    ...
    <div class="shop-info-box">
      ...
      <div v-if="navStatus === 0" class="basic-info-mod">
        ...
        <div class="business-info-mod-wrap" v-if="!isShopInfoBrowsing">
          <div class="business-info-mod">
            <el-form @submit.native.prevent ref="shopBasicInfo" label-width="140px" :model="shopBasicInfo" :rules="shopBasicInfoRules" size="small">
              <div class="ci-wrapper">
                <div class="left-info">
                  ...
                  <el-form-item :label="this.$i18n.t('shopProcess.tel')" prop="tel">
                    <p class="txt">
                      <el-input v-model="shopBasicInfo.tel" maxlength="11" oninput="value=value.replace(/[^\d]/g,'')" :placeholder="this.$i18n.t('shopProcess.telInputTips')" />
                    </p>
                  </el-form-item>
                  <el-form-item :label="this.$i18n.t('shopProcess.receiveMobile')" prop="receiveMobile">
                    <p class="txt">
                      <el-input v-model="shopBasicInfo.receiveMobile" oninput="value=value.replace(/[^\d]/g,'')" :placeholder="this.$i18n.t('shopProcess.receiveMobileTips')" maxlength="11" />
                    </p>
                  </el-form-item>
          ...
          <div class="footer">
          <div class="foot-box">
            <div v-if="isAuth('shop:shopDetail:save')" class="btn default-btn primary-btn" @click="validationShopBasicInfo">{{ $t('shopProcess.saveBasicInfo') }}</div>
          </div>
          </div>
        </div>
        ...
        <div class="s-category-item s-item">
          <div class="apply-sign">
            ...
            <div>
              ...
              >{{ $t('shopProcess.applySigningCategory') }}</div>
              <div
              ...
              >{{ $t('shopProcess.seeApplySigningCategory') }}</div>
            </div>
          </div>
        ...
        <div class="s-brand-item s-item">
          <div class="apply-sign">
            ...
            <div>
              ...
              >{{ $t('shopProcess.applySigningBrand') }}</div>
              <div
              ...
              >{{ $t('shopProcess.seeApplySigningBrand') }}</div>
            </div>
          </div>
      ...
      <div v-if="navStatus === 3" class="financial-info">
        ...
        <div
          v-if="settlementAccounts.length < 5 && isAuth('shop:shopBankCard:save')"
          ...
          >
            ...
            >
              <template slot-scope="scope">
                ...
                <!-- <el-tag :type="scope.row.isDefault ? 'success' : ''">{{ scope.row.isDefault ? '是' : '否' }}</el-tag> -->
              </template>
            </el-table-column>
            <el-table-column
              fixed="right"
              ...
              <template slot-scope="scope">
                <div class="text-btn-con">
                  <div
                    ...
                    @click="showDialog(scope.row.shopBankCardId)"
                  >
                  ...
                  <div
                    ...
                    @click="deleteBankCartById(scope.row.cardNo, scope.row.shopBankCardId)"
                  >
                    {{$t("text.delBtn")}}
                  </div>
                  <div
                    ...
                    @click="setMainAccountById(scope.row.shopBankCardId)"
                  >
                  ...
                  <div
                    ...
                    @click="setNotMainAccountById(scope.row.shopBankCardId)"
                  >
...
export default {
  ...
  data () {
    ...
    return {
      ...
      shopBasicInfoRules: {
        ...
        shopAddress: [
          { required: true, message: this.$i18n.t('shopProcess.detailAddrNotEmpty'), trigger: ['blur', 'change'] }
        ],
        shopLogo: [
  ...
  methods: {
        ...
        if (this.mapLocationType === 'map') {
          gc.getLocation(point, function (rs) {
            if (rs) {
              ...
              addrDetail && (that.shopBasicInfo.shopAddress = addrDetail)
            }
    ...
    formatAddrDetail (addrInfo) {
      const rex = new RegExp(`[${this.shopBasicInfo.province}|${this.shopBasicInfo.city}|${this.shopBasicInfo.area}]`, 'g')
    ...
    validateTime (value) {
      ...
      if (this.companyInfoForm.endTime && Date.parse(this.companyInfoForm.startTime) >= Date.parse(this.companyInfoForm.endTime)) {
        this.$message({
          message: this.$t('shopProcess.businessStartEndTime'),
          type: 'error',
          duration: 1500
        })
      }
