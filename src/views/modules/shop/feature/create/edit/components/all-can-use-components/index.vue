  ...
  data () {
    return {
      componentLists: [// 所有可用的组件
        ...
        {
          type: 'goodsWaterfall',
          title: this.$i18n.t('shopFeature.allCanUse.goodsWaterfall'),
          pic: require('@/assets/img/micro-page/goods-waterfall.png'),
          picActive: require('@/assets/img/micro-page/goods-waterfall-active.png'),
          routerPath: () => import('../goods-waterfall/index.vue')
        },
        // 图片广告
        {
          type: 'imageAd',
