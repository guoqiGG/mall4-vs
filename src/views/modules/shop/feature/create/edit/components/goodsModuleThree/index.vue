  ...
  methods: {
    ...
    checkData () {
      ...
      if (this.formData.mainTitle === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule3') + this.$t('shopFeature.goodsModule.goodsModuleTip1')
      } else if (this.formData.goodsList.length === 0) {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule2') + this.$t('shopFeature.goodsModule.goodsModuleTip6')
      } else {
        isPass = true
        errMessage = ''
      }
