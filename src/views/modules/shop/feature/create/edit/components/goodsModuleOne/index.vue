  ...
  methods: {
    ...
    checkData () {
      ...
      if (this.formData.leftConfig.mainTitle === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule1') + this.$t('shopFeature.goodsModule.goodsModuleTip7')
      } else if (this.formData.leftConfig.subTitle === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule1') + this.$t('shopFeature.goodsModule.goodsModuleTip8')
      } else if (this.formData.leftConfig.goodsList.length === 0) {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule1') + this.$t('shopFeature.goodsModule.goodsModuleTip6')
