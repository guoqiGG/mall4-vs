      ...
      <div class="design-config-editor">
        ...
        <div class="design-editor-component-container">
          <div class="image-ad-edit">
            ...
            <el-form @submit.native.prevent ref="formData"
                    class="ad-form"
                    label-width="100px"
              ...
              <el-form-item
                v-if="formData.swiperOption.indicatorDots"
                :label="$i18n.t('shopFeature.imageAd.actDotLoc')"
              >
                <el-slider v-model="formData.swiperOption.indicatorBottom" style="width: 80%" :show-tooltip="showTooltip" show-input input-size="mini" :min="0" :max="formData.imgHeight - 10" @input="changeBoxHeight(true)" @change="changeBoxHeight(false)" />
              </el-form-item>
            </el-form>
            ...
            <div class="ad-edit-item">
              ...
              <div class="ad-edit-item-title ad-edit-img-height">
                ...
                <el-slider v-model="formData.imgHeight" style="width: 80%" @input="changeBoxHeight(true)" @change="changeBoxHeight(false)" :show-tooltip="showTooltip" show-input input-size="mini" :min="100" :max="400"></el-slider>
              </div>
              <div class="ad-edit-item-title">
  ...
  methods: {
    ...
    handleDialogSubmit ({ type, value }) {
      if (type === '1') { // 当前选择的是商品
        ...
        this.$set(this.formData.imageList[this.currentImgIndex].path, 'name', value.customLink.url)
