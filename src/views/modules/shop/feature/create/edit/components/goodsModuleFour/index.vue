  ...
  methods: {
    ...
    checkData () {
      ...
      if (this.formData.topImg === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule4') + this.$t('shopFeature.goodsModule.goodsModuleTip9')
      } else if (this.formData.path.name === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule4') + this.$t('shopFeature.goodsModule.goodsModuleTip10')
      } else if (this.formData.goodsList.length === 0) {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule4') + this.$t('shopFeature.goodsModule.goodsModuleTip6')
      } else {
        isPass = true
        errMessage = ''
      }
