    ...
    <div class="design-preview-controller">
      <div class="title-text-content"
        ...
        <div class="title-text-title"
             :style="{fontSize:formData.titleSize+'px',fontWeight:formData.titleWeight, 'width':!formData.isLink?'100%':formData.linkStyle==1?'80%':formData.linkStyle==2?'75%':'90%'}">
          {{ formData.title }}
        </div>
        <div class="show-more"
          ...
          <el-form @submit.native.prevent ref="formData"
            ...
            <el-form-item :label="$i18n.t('shopFeature.titText.titContent')"
              ...
              <el-input v-model="formData.title" :maxlength="100"
                        :placeholder="$i18n.t('shopFeature.titText.titContent')"></el-input>
            </el-form-item>
            ...
            <div v-if="formData.isLink"
              ...
              <div class="btn-type-input">
                ...
                <!-- <el-select v-model="formData.link.type" :placeholder="$i18n.t('shopFeature.tabNav.choose')" @change="handleLinkTypeChange" size="small">
                  <el-option
  ...
  methods: {
    ...
    handleDialogSubmit ({ type, value }) {
      if (type === '1') { // 当前选择的是商品
        ...
        this.$set(this.formData.path, 'name', value.customLink.url)
