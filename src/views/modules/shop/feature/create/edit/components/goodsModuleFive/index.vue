  ...
  methods: {
    ...
    handleDialogSubmit ({type, value}) {
      if (this.currentOperation === 'goods') {
        ...
        if (type === '1') { // 当前选择的是商品
          ...
          this.$set(this.formData.leftMessage.path, 'name', value.customLink.url)
        ...
        if (type === '1') { // 当前选择的是商品
          ...
          this.$set(this.formData.rightMessage.path, 'name', value.customLink.url)
    ...
    checkData () {
      ...
      if (this.formData.leftMessage.img === '' || this.formData.rightMessage.img === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule5') + this.$t('shopFeature.goodsModule.goodsModuleTip9')
      } else if (this.formData.leftMessage.path.name === '' || this.formData.rightMessage.path.name === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule5') + this.$t('shopFeature.goodsModule.goodsModuleTip10')
      } else if (this.formData.goodsList.length === 0) {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule5') + this.$t('shopFeature.goodsModule.goodsModuleTip6')
      } else {
        isPass = true
        errMessage = ''
      }
