      ...
      <div class="design-config-editor">
        ...
        <div class="tab-nav-set design-editor-component-container">
          ...
          <div class="tab-set-box">
            <el-form @submit.native.prevent ref="formData" class="edit-form" size="small">
              <el-form-item :label="$i18n.t('shopFeature.imageAd.selModel')" class="tab-set-style">
  ...
  methods: {
    ...
    handleDialogSubmit ({type, value}) {
      if (type === '1') { // 当前选择的是商品
        ...
        this.$set(this.formData.nav[this.currentNavIndex].path, 'name', value.customLink.url)
