  ...
  methods: {
    ...
    handleDialogSubmit ({ type, value }) {
      if (type === '1') { // 当前选择的商品
        ...
        if (this.currentActive === 1) { // 左边配置
          if (this.currentOperation === 'immediaty') { // 立即抢购
            this.$set(this.formData.leftConfig.path, 'name', value.customLink.url)
            this.$set(this.formData.leftConfig.path, 'link', value.customLink)
            this.$set(this.formData.leftConfig.path, 'type', '6')
          } else if (this.currentOperation === 'addImg') { // 添加图片
            this.$set(this.formData.leftConfig.imgMessage.path, 'name', value.customLink.url)
          ...
          if (this.currentOperation === 'immediaty') { // 立即抢购
            this.$set(this.formData.topConfig.path, 'name', value.customLink.url)
            this.$set(this.formData.topConfig.path, 'link', value.customLink)
            this.$set(this.formData.topConfig.path, 'type', '6')
          } else if (this.currentOperation === 'addImg') { // 添加图片
            this.$set(this.formData.topConfig.imgMessage.path, 'name', value.customLink.url)
          ...
          if (this.currentOperation === 'immediaty') { // 立即抢购
            this.$set(this.formData.bottomConfig.path, 'name', value.customLink.url)
            this.$set(this.formData.bottomConfig.path, 'link', value.customLink)
            this.$set(this.formData.bottomConfig.path, 'type', '6')
          } else if (this.currentOperation === 'addImg') { // 添加图片
            this.$set(this.formData.bottomConfig.imgMessage.path, 'name', value.customLink.url)
    ...
    checkData () {
      ...
      if (this.formData.leftConfig.mainTitle === '' || this.formData.topConfig.mainTitle === '' || this.formData.bottomConfig.mainTitle === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule2') + this.$t('shopFeature.goodsModule.goodsModuleTip1')
      } else if (this.formData.leftConfig.subTitle === '' || this.formData.topConfig.subTitle === '' || this.formData.bottomConfig.subTitle === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule2') + this.$t('shopFeature.goodsModule.goodsModuleTip2')
      } else if (this.formData.leftConfig.path.name === '' || this.formData.topConfig.path.name === '' || this.formData.bottomConfig.path.name === '') {
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule2') + this.$t('shopFeature.goodsModule.goodsModuleTip3')
        ...
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule2') + this.$t('shopFeature.goodsModule.goodsModuleTip4')
        ...
        isPass = false
        errMessage = this.$t('pcdecorate.componentTitle.goodsModule2') + this.$t('shopFeature.goodsModule.goodsModuleTip5')
      } else {
        isPass = true
        errMessage = ''
      }
      if (isPass) {
        ...
        this.$newMessage.error(errMessage)
      }
    }
  }
}
