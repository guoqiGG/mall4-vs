            ...
            <div style="display: flex">
              ...
              <span class="end-time">
                <el-date-picker
                  ...
                  type="date"
                  value-format="yyyy-MM-dd HH:mm:ss"
                  :placeholder="isNotEdit && !companyInfoForm.endTime ? '' : this.$i18n.t('shopProcess.endTime')"
                  clearable
                  :disabled="isNotEdit"
                />
                <span v-if="isNotEdit && !companyInfoForm.endTime" class="text">
...
export default {
  ...
  data () {
    ...
    return {
      lang: window.localStorage.getItem('bbcLang'), // 语言
...
.shop-business .ci-wrapper{
  ::v-deep .up-img-box .plugin-images .el-upload.el-upload--picture-card{
    width: 130px;
    height: 130px;
  }
}
::v-deep .plugin-images .el-upload-list--picture-card .el-upload-list__item {
  width: 130px;
  height: 130px;
}
