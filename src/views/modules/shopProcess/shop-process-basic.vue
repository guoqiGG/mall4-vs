      ...
      <div class="ci-wrapper">
        <div class="left-info">
          ...
          <el-form-item :label="this.$i18n.t('shopProcess.tel')" prop="tel">
            <el-input v-model="baseInfoForm.tel" oninput="value=value.replace(/[^\d]/g,'')" :placeholder="this.$i18n.t('shopProcess.telInputTips')" maxlength="11" :disabled="isNotEdit" />
          </el-form-item>
...
export default {
    ...
    return {
      ...
      baseInfoRule: {
        merchantName: [
          ...
          { min: 2, max: 10, message: this.$i18n.t('shopProcess.merchantNameInputTips'), trigger: 'blur' },
  ...
  methods: {
        ...
        if (this.mapLocationType === 'map') {
          gc.getLocation(point, function (rs) {
            if (rs) {
              ...
              addrDetail && (that.baseInfoForm.shopAddress = addrDetail)
            }
          })
        }
        area = this.baseInfoForm.province + this.baseInfoForm.city + this.baseInfoForm.area + this.baseInfoForm.shopAddress
    ...
    formatAddrDetail (addrInfo) {
      const rex = new RegExp(`[${this.baseInfoForm.province}|${this.baseInfoForm.city}|${this.baseInfoForm.area}]`, 'g')
    ...
    saveBasicInfo () {
      ...
      this.$refs['baseInfoForm'].validate((valid) => {
        if (!this.baseInfoForm.cityId) {
          return this.$message.warning(this.$i18n.t('shopProcess.addrInputTips'))
        }
