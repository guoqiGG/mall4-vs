<template>
  <div class="shop-transcity-add-or-update">
    <el-dialog
      :modal="false"
      :title="this.$i18n.t('shop.chooseDeliveryArea')"
    ...
    >
      ...
      >
        <el-scrollbar style="height:100%">
          <el-form-item size="mini" :label="this.$i18n.t('product.deliveryArea')">
            <el-tree
              :data="menuList"
      ...
      <span slot="footer" class="dialog-footer">
        <el-checkbox v-model="checkedAllState" :indeterminate="checkedAllIndeterminate" :disabled="checkedAllDisabled" @change="checkedAll">全选</el-checkbox>
        <span>
...
export default {
  ...
  methods: {
    ...
    checkedAllJudge () {
      ...
      // 是否为禁用状态
      this.checkedAllDisabled = disabledNum === len
      // 是否为不确定的状态
