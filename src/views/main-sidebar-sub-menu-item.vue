<template>
  <div class="muen-mod" v-if="expandMenu.hidden === 0">
    ...
    <div v-else>
      <el-menu-item v-if="!expandMenu.hidden" style="font-size: 14px !important;height: 40px !important;padding-left: 15px !important;line-height: 40px;"  @click="gotoRouteHandle(expandMenu)" :key="expandMenu.menuId" class="menu-right-el-item is-active item-text" :class="{'menu-active': selectRightId === expandMenu.menuId}">
