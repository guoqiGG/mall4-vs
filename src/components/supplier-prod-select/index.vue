<template>
  <el-dialog
    ...
    custom-class='supplierProdSelect'
  >
                  ...
                  <div class="prod-item">
                    <div class="item" style="margin-left:15%;width:80%">
                      <div class="prod-image" style="margin-right:0">
                        <ImgShow :src="prod.pic" :imgStyle="{width:'60px',height:'60px'}"  />
                      </div>
                      <el-tooltip class="prod-name" effect="dark" :content="prod.prodName" placement="top">
                        <div>
                          {{prod.prodName}}
                        </div>
                      </el-tooltip>
