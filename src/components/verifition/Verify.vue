...
export default {
  ...
  methods: {
    ...
    uuid () {
      ...
      // 判断下是否存在 slider
      console.log(localStorage.getItem('bbcSlider'))
      if (!localStorage.getItem('bbcSlider')) {
        localStorage.setItem('bbcSlider', slider)
      }
      if (!localStorage.getItem('bbcPoint')) {
        localStorage.setItem('bbcPoint', point)
      }
    },
    /**
             * i18n
