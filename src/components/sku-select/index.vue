<template>
  ...
  >
    <el-form @submit.native.prevent :inline="true" :model="dataForm" class="demo-form-inline" size="small">
          ...
          <template slot-scope="scope">
            <div class="prod-item">
              <div class="select-dor">
                <el-radio v-if="isRadio && limit === 1" :label="scope.row.prodId" v-model="checkProdId" @change="radioCheckProd(scope.$index)"  :disabled="checkMainProdIds(scope.row.prodId)">&nbsp;</el-radio>
              ...
              <div class="prod-info">
                <div class="prod-image">
                  <ImgShow :src="scope.row.pic" :classList="['prod-img']" />
                </div>
                <div class="prod-name">
                  {{scope.row.prodName}}
                </div>
...
.sku-select-main .el-table__fixed {
